...
gs_target = _setc.build_gateset([4], [('Q0', 'Q1')],
                                ['Gix', 'Giy', 'Gxi', 'Gyi', 'Gii', 'Gxx', 'Gyy', 'Gxy', 'Gyx'],
                                ["I(Q0):X(pi/2,Q1)", "I(Q0):Y(pi/2,Q1)", "X(pi/2,Q0):I(Q1)",
                                 "Y(pi/2,Q0):I(Q1)", "I(Q0):I(Q1)", "X(pi/2,Q0):X(pi/2,Q1)",
                                 "Y(pi/2,Q0):Y(pi/2,Q1)", "X(pi/2,Q0):Y(pi/2,Q1)",
                                 "Y(pi/2,Q0):X(pi/2,Q1)"],
